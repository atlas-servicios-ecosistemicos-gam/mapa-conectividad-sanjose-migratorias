---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en el cantón de San José"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/sanjose/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_SAN_JOSE_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_migratorias_san_jose/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_migratorias_san_jose/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.000003047, 0.000009851, 0.000032290, 0.000169294, Inf)
...
# Importancia
bins_importancia <- c(0, 1730299591.59, 4707773325.43, 8019365310.36, 63391517795.90, Inf)
